<?php
  ...
  //  mysqli_query($connection,"DELETE FROM books_data WHERE Author_name = '$name'");
   $data = mysqli_query($connection,"SELECT * FROM books_data WHERE Author_name = '$name' ")or die(mysqli_error($connection));
?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <body>
         ...
         <div class="container my-4 " style="height: 60px;"></div> 
            <div class="container-fluid">
                <h2 class="mt-3 mb-4 font-weight-bold" style="font-family: 'Ubuntu', sans-serif;"> Available Books By : <?php echo $name; ?></h2>
                <div class="row mb-4">
                  ...
                  <div class="col-md-3 ">
                    ...
                    <?php
                     echo"<img src=".$value['image']." class='img-fluid ' style='height: 310px;' >";
                     ?>
