        ...
        <div class="row">
          ...
          <div class="row">
            <div class="container text-center my-4">
              <h1 class="font-weight-bold" style="font-family: 'Ubuntu', sans-serif;">Welcome ! Delete your books here.</h1>
            </div>
            ...
            <div class="col-md-2 text-center">
              ...
              <img src="images/delete.png" class="img-fluid mt-2" style="height: 150px;">
            </div>
          </div>
        </div>
      </div>
      <div class="container-fluid pb-5 mt-3">
        <div class="row pt-5">
          <div class="col-md-3">
            ...
            <div class="card mt-3">
              <div class="card-body">
                <form action="#" method="post" name="update_id">
                  <input class="form-control" name="id" placeholder="Enter Id" style="font-family: 'Ubuntu', sans-serif; "/><br />
                  <input  class="btn btn-block" style="background-color: #9bc472;color: white;font-family: 'Ubuntu', sans-serif;" type="submit" name="delete" value="Delete" /><br /><br />
                </form>
              </div>
            </div>
          </div>
